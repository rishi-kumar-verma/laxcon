...
<div class="preloader-background">
    ...
    <nav class="fixedtop topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" class="brand-logo brand-logo-title">Contact</a>
                ...
                <div class="section">
                    <div class="row ">
                        <div class="col s12 pad-0">
                            <h5 class="bot-20 sec-tit  ">Address</h5>
                            <div>Plot No.235, Sarkhej Bavla , NH8A, Village Sari, Taluka Sanand, Ahmedabad - 382220, Gujarat, India
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row ">
                        <div class="col s12 pad-0">
                            <h5 class="bot-20 sec-tit  ">Contact</h5>
                            <div>Phone: +91-2717-610800 (100 lines)
                    ...
                    <div class="row ">
                        <div class="col s12 pad-0">
                            <h5 class="bot-20 sec-tit  ">Email</h5>
                            <div>sales@laxconsteels.com
                            </div>
                        </div>
