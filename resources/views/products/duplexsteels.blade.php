...
<body class="html" data-header="light" data-footer="light" data-header_align="app" data-menu_type="left" data-menu="light" data-menu_icons="on" data-footer_type="left" data-site_mode="light" data-footer_menu="show" data-footer_menu_style="light">
    ...
    <nav class="fixedtop topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" class=" brand-logo ">Duplex Steels</a>
        ...
        <div class="content-area">
            <div class="container  is-pagetitle">
                <div class="section">
                    ...
                    <img alt="image" style="width: 100%;" src="resources/assets/images/duplex.jpg">

                    <p>Duplex stainless steels are called "duplex" because they have a two-phase microstructure consisting of grains of ferritic and austenitic stainless steel. This structure provides a unique set of benefits.</p>
                    ...
                    <br>
                    <div class="center">
                        <a href="https://www.laxconsteels.com/duplex-steels/" target="_blank"><button class="btn-full waves-effect waves-light red darken-1 tooltipped col s2">More Info
