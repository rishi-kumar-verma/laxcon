...
<body class="html" data-header="light" data-footer="light" data-header_align="app" data-menu_type="left" data-menu="light" data-menu_icons="on" data-footer_type="left" data-site_mode="light" data-footer_menu="show" data-footer_menu_style="light">
    ...
    <nav class="fixedtop topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" class=" brand-logo ">Equal Angles</a>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="content-area">
            <div class="container  is-pagetitle">
                <div class="section">
                    <img alt="image" style="width: 100%;" src="resources/assets/images/equalangle.jpg">
                    <p>Equal angle is used in metal construction, industrial and agricultural applications. Various pieces of metal frames, metal brackets, steel chassis, components and parts of machinery can be made from equal angle. Equal angles are available
                        with various types of bar end finish for example-chamfered ends, plain ends without burrs or sharp edges. They go through hot Rolling ,annealing and pickling to improve their material properties.</p>
                    ...
                    <br>
                    <div class="center">
                        <a href="https://www.laxconsteels.com/equal-angles/" target="_blank"><button class="btn-full waves-effect waves-light red darken-1 tooltipped col s2">More Info
