...
<body class="html" data-header="light" data-footer="light" data-header_align="app" data-menu_type="left" data-menu="light" data-menu_icons="on" data-footer_type="left" data-site_mode="light" data-footer_menu="show" data-footer_menu_style="light">
    ...
    <nav class="fixedtop topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" class=" brand-logo ">Hot Rolled Round Corner Squares</a>
        ...
        <div class="content-area">
            <div class="container  is-pagetitle">
                <div class="section">
                    ...
                    <img alt="image" style="width: 100%;" src="resources/assets/images/holrolledround.jpg">
                    <p>These are created with free of surface defects/cracks as well as they have uniform internal structure, which is an absolute requirement while producing drop forged parts in the automotive industry. The radius edge also creates a safety feature by eliminating sharp edges.</p>
                    ...
                    <br>
                    <div class="center">
                        <a href="https://www.laxconsteels.com/hot-rolled-round-corner-squares-rcs/" target="_blank"><button class="btn-full waves-effect waves-light red darken-1 tooltipped col s2">More Info
