...
<body class="html" data-header="light" data-footer="light" data-header_align="app" data-menu_type="left" data-menu="light" data-menu_icons="on" data-footer_type="left" data-site_mode="light" data-footer_menu="show" data-footer_menu_style="light">
    ...
    <nav class="fixedtop topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" class=" brand-logo ">Precipitation Hardening Steel</a>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="content-area">
            <div class="container  is-pagetitle">
                <div class="section">
                    <img alt="image" style="width: 100%;" src="resources/assets/images/hardening.jpg">
                    <p>Precipitation Hardening stainless steels are chromium and nickel containing steels that provide an optimum combination of the properties of Martensitic and
                        Austenitic grades. Like Martensitic grades, they are known for their ability to gain high strength through heat treatment and they also have the corrosion resistance of austenitic stainless steel.</p>
                    ...
                    <br>
                    <div class="center">
                        <a href="https://www.laxconsteels.com/precipitation-hardening-steel/" target="_blank"><button class="btn-full waves-effect waves-light red darken-1 tooltipped col s2">More Info
