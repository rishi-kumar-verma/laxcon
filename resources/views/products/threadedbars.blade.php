...
<body class="html" data-header="light" data-footer="light" data-header_align="app" data-menu_type="left" data-menu="light" data-menu_icons="on" data-footer_type="left" data-site_mode="light" data-footer_menu="show" data-footer_menu_style="light">
    ...
    <nav class="fixedtop topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" class=" brand-logo ">Threaded Bars </a>
        ...
        <div class="content-area">
            <div class="container  is-pagetitle">
                <div class="section">
                    ...
                    <img alt="image" style="width: 100%;" src="resources/assets/images/thread.jpg">
                    <p>Threaded bars are used in various sectors such as construction, marine, automobile, plumbing, manufacturing etc. They work as a fastener to join metal or wood together or act as a pin to connect the two materials. They are also used in special purpose machines where proper alignment is required.</p>
                    ...
                    <br>
                    <div class="center">
                        <a href="https://www.laxconsteels.com/threaded-bars/" target="_blank"><button class="btn-full waves-effect waves-light red darken-1 tooltipped col s2">More Info
