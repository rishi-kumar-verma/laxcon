...
<body class="antialiased isfullscreen  html" data-header="light" data-footer="light" data-header_align="app" data-menu_type="left" data-menu="light" data-menu_icons="on" data-footer_type="left" data-site_mode="light" data-footer_menu="show" data-footer_menu_style="light">
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="content-area">
            <h1 class="white-text center welcome-logo index-welcome"><a href="index.html"><img src="resources/assets/images/logo.png"></a></h1>
            <div class="fullfixed index-carousel">
                ...
                <div class="carousel carousel-fullscreen carousel-slider">
                    ...
                    <a class="carousel-item" href="#carousel-slide-0!">
                        <div class="bg" style="background-image: url('assets/images/three.jpg')"></div>
                    ...
                    <a class="carousel-item" href="#carousel-slide-1!">
                        <div class="bg" style="background-image: url('assets/images/two.jpg')"></div>
                        <div class="item-content center-align white-text">
                    ...
                    <a class="carousel-item" href="#carousel-slide-2!">
                        <div class="bg" style="background-image: url('assets/images/one.jpg')"></div>
                        <div class="item-content center-align white-text">
                    ...
                    <a class="carousel-item" href="#carousel-slide-3!">
                        <div class="bg" style="background-image: url('assets/images/four.jpg')"></div>
                        <div class="item-content center-align white-text">
            ...
            <div class="center index-start">
                <a href="login.html" class='waves-light btn-large red darken-1 tooltipped col s2'> Get Started
                </a>
            </div>
        </div><!--.content-area-->
